...
//        setContentView(R.layout.activity_calculator__page);
//    }
//}
...
//        btnCE = (Button) findViewById(R.id.btnCE);
        ...
        btnNumberPercentage = (Button)findViewById(R.id.btnNumberPercentage);
        btnCalci2 = (Button)findViewById(R.id.btnCalci2);
...
//        });
        ...
        btnNumberPercentage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ACTION = "%";
                if(!Double.isNaN(val1)){
//                    val2 = Double.parseDouble(edtInput.getText().toString());
                    //val2 = Double.parseDouble(txtResult.getText().toString());
                    val1 = val1/100;
                } else {
                    val1 = Double.parseDouble(edtInput.getText().toString());
                    val1= val1/100;
